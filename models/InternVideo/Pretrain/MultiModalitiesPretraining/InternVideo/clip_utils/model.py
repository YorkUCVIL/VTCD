...
class VideoIntern(nn.Module):
    ...
    def encode_video(
        self, video, return_all_feats=False, masked_indices=None, mode="video", return_features=True
    ):
        # video: [N, C, T, H, W]
        feats, clust_features = self.visual(video, return_all_feats=return_all_feats, mode=mode)
