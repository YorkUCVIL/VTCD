...
GSO_CONTAINER_IDS = [
    ...
    # '3D_Dollhouse_Sink',  # TODX this is special / rotated
    # 'Snack_Catcher_Snack_Dispenser',  # NOTE: is not open
]
GSO_CARRIER_IDS = [
...
GSO_BOX_CONTAINS = [
    ...
    'asus',
    'bean',
    # 'berry',  # Acidentally contained ASICS shoe, so changed to super_berry.
    'blender',
    'brother_printing',
    'capsules',
    'chocolate_cube',
...
# These are other things used for pushing that are not boxes.
# (abandoned)
# GSO_PUSHER_CONTAINS = [
# ]
