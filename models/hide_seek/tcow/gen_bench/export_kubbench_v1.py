...
python gen_bench/export_kubbench_v1.py
pkill -9 python
du -sh /tmp/
rm -rf /tmp/*

Based mostly on: kubcon_v7 and kubcon_v8.

Notes / fixes before v2:
- IMPORTANT: Camera yaw was accidentally still fixed (due to multi-view) => randomized for v2.
'''
