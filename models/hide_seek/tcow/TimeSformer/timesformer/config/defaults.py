...
# Learning rate policy (see utilities/lr_policy.py for options and examples).
...
# If specified, the visualized results will be written this a video file of
# this path. Otherwise, the visualized results will be displayed in a window.
_C.DEMO.OUTPUT_FILE = ""
