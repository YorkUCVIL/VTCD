...
python experimental/2_profile_movi_def.py

tensorboard --logdir=./experimental/kb_log
...
if __name__ == '__main__':
  ...
  # NOTE: This causes Segmentation fault (core dumped)
  # regardless of the arguments I give it..

#   logging.info('initializing profile')
#   prof = torch.profiler.profile(
#     schedule=torch.profiler.schedule(wait=1, warmup=1, active=3, repeat=2),
#     on_trace_ready=torch.profiler.tensorboard_trace_handler('./experimental/kb_log/2_movi_def_v1'),
#     record_shapes=True,
