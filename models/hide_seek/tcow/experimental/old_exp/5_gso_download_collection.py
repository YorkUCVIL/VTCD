...
#
'''
https://app.gazebosim.org/GoogleResearch/fuel/collections/Google%20Scanned%20Objects
python3 5_gso_download_collection.py -o "GoogleResearch" -c "Google Scanned Objects"
'''
