...
import models.VideoMAE.modeling_pretrain
from models.VideoMAE.datasets import DataAugmentationForVideoMAE
from torchvision.transforms import ToPILImage
from einops import rearrange
from timm.data.constants import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
from decord import VideoReader, cpu
from torchvision import transforms
from models.VideoMAE.transforms import *
from models.VideoMAE.masking_generator import  TubeMaskingGenerator
...
def get_args():
    ...
    parser.add_argument('--save_path', default='', type=str, help='save video path')
